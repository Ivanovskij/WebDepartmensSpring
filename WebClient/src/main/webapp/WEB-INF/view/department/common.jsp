...
<body id="body">
    ...
    <div class="container">
        <div class="row">
            <!-- Sidebar -->
            <c:url value="${contextRoot}/departments" var="list"/>
            <c:url value="${contextRoot}/departments/create" var="create"/>
            <c:url value="${contextRoot}/departments/update" var="update"/>
            <c:url value="${contextRoot}/departments/delete" var="delete"/>
            <c:url value="${contextRoot}/departments/averageSalary" var="averageSalary"/>
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    ...
                    <a id="link_avgSalary" href="${averageSalary}" class="list-group-item">Average salary</a>
                </div>
            </div>
            <!-- /.col-lg-3 -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <c:if test="${userClickAverageSalary == true}">
                            <%@include file="averageSalary.jsp"%>
                        </c:if>
